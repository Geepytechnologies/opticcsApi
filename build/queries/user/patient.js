...
WHERE
  ...
  p.id DESC LIMIT ${pageSize} OFFSET ${offset};`;
    ...
    static getPatientsWithHealthworkerwithdate(pageSize, offset) {
        return `SELECT
    p.*,
    hp.*,
    pi.*,
  ...
  `;
    ...
    static getPatientsWithHealthworkerFilteredByStatewithdate(pageSize, offset) {
        return `SELECT
    p.*,
    hp.*,
    pi.*,
  ...
  `;
    ...
    static getPatientsWithHealthworkerFilteredByLgawithdate(pageSize, offset) {
        return `SELECT
    p.*,
    hp.*,
    pi.*,
  ...
  `;
    ...
    static getPatientsWithHealthworkerFilteredByHealthfacilitywithdate(pageSize, offset) {
        return `SELECT
    p.*,
    hp.*,
    pi.*,
