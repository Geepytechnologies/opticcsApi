...
exports.resetpassword = exports.signout = exports.generatelgadetails = exports.handleRefreshToken = exports.signin = void 0;
//@ts-nocheck
...
const generateUniqueCredentials = (callback) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [results, fields] = yield connection.execute("SELECT * FROM lgadmin WHERE userid = ?", [username]);
        if (results.length > 0) {
...
const generatelgadetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.generatelgadetails = generatelgadetails;
...
const handleRefreshToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(cookies === null || cookies === void 0 ? void 0 : cookies.lgatoken))
