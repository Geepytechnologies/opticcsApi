...
`CREATE TABLE returnvisit (
  ...
  bloodpressdia TEXT,
  bloodpresssis TEXT,
  chestpaindiscuss TEXT,
  epigastricpaindiscuss TEXT,
  severetireddisuss TEXT,
  severediarrhoeadiscuss TEXT,
  swellingfeetdiscuss TEXT,
  sputrumcolor TEXT,
  sputrum TEXT,
  lmp TEXT,
  lmpdate DATE,
