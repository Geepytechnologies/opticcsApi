...
const createPatient = async (req, res, next) => {
  ...
  const getnewlycreatedpatientrecord = async (patient_id) => {
    const q = `SELECT
    p.id, p.healthpersonnel_id, p.personalinformation_id,
    pi.hospitalnumber,
      pi.firstname,
      pi.middlename,
      pi.surname,
      ...
      pi.lastmonthseenperiod,
    fv.patient_id, fv.firstvisit_date,
    dhal.doyousmoke,
    ...
    pe.conjunctiva,pe.sclera,pe.bloodpressure,pe.respiratoryrate,pe.temperature,pe.pulserate,
    pe.abdomenScars,
