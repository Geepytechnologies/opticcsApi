export class ScheduleQueries {
  ...
  static getAllScheduleNational(pageSize: number, offset: number) {
  ...
  static getAllScheduleNationalwithdate(pageSize: number, offset: number) {
    return `SELECT schedule.*, personalinformation.firstname,
    personalinformation.middlename,
    personalinformation.surname,
    personalinformation.state,personalinformation.lga,
  ...
  static getAllScheduleState(pageSize: number, offset: number) {
    return `SELECT schedule.*, personalinformation.firstname,
    personalinformation.middlename,
    personalinformation.surname,
    personalinformation.state,personalinformation.lga,
  ...
  static getAllScheduleStatewithdate(pageSize: number, offset: number) {
    return `SELECT schedule.*, personalinformation.firstname,
    personalinformation.middlename,
    personalinformation.surname,
    personalinformation.state,personalinformation.lga,
  ...
  static getAllScheduleLga(pageSize: number, offset: number) {
    return `SELECT schedule.*, personalinformation.firstname,
    personalinformation.middlename,
    personalinformation.surname,
    personalinformation.state,personalinformation.lga,
  ...
  static getAllScheduleLgawithdate(pageSize: number, offset: number) {
    return `SELECT schedule.*, personalinformation.firstname,
    personalinformation.middlename,
    personalinformation.surname,
    personalinformation.state,personalinformation.lga,
  ...
  static getAllScheduleHealthfacility(pageSize: number, offset: number) {
    return `SELECT schedule.*, personalinformation.firstname,
    personalinformation.middlename,
    personalinformation.surname,
    personalinformation.state,personalinformation.lga,
  ...
  static getAllScheduleHealthfacilitywithdate(
    pageSize: number,
    offset: number
  ) {
    return `SELECT schedule.*, personalinformation.firstname,
